...
if($PSVersiontable.PSVersion.Major -lt 3)
{
    ...
    Write-Output "Download from: https://www.python.org/ftp/python/3.10.2/python-3.10.2-embed-amd64.zip"
...
{
    Invoke-WebRequest -Uri https://www.python.org/ftp/python/3.10.2/python-3.10.2-embed-amd64.zip -OutFile python.zip
...
((Get-Content python\python310._pth)) -Replace "#import", "import" | Set-Content python\python310._pth
Set-Content python\python310._pth -value "../", (Get-Content python\python310._pth)
